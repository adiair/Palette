      ...
      <section className="relative rounded-2xl shadow-xl border-4 border-white/80 p-5 max-h-[90vh] overflow-y-auto w-full max-w-xl bg-black/40 backdrop-blur-lg">
        ...
        <nav className="w-full max-w-6xl mb-2 flex flex-row sm:flex-row justify-between px-4 sm:px-8 items-center mt-10">
          <div className="flex items-center mb-4 sm:mb-0">
            ...
            ></div>
            <h1 className="text-xl sm:text-2xl font-bold text-black hover:text-blue-400 transition">
              Preview : Logo
            </h1>
          </div>
          <ul className="flex gap-2 sm:gap-4 text-sm font-medium">
            {["Nav-", "-Bar"].map((item, idx) => (
              <li
                key={idx}
                className="px-4 py-1 rounded-full text-black font-semibold shadow-sm border border-white/20 bg-opacity-10 backdrop-blur-md hover:bg-blue-500 hover:text-white transition"
